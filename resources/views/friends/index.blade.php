                    ...
                    @forelse($friends as $item)
                        ...
                        <div class="py-4 first:pt-0 last:pb-0 flex items-center justify-between group hover:bg-slate-50/50 -mx-6 px-6 transition duration-200"
                            ...
                            <div class="flex items-center gap-4">
                                ...
                                <img src="https://i.pravatar.cc/150?u={{ $item['user']->email }}" 
                                     alt="{{ $item['user']->name }}" 
                                     class="h-11 w-11 rounded-full object-cover border border-slate-100 shadow-sm"
                                     onerror="this.style.display='none'; this.nextElementSibling.style.display='flex'">
                                
                                <!-- Letter Initials fallback -->
                                <div class="h-11 w-11 rounded-full bg-gradient-to-tr from-purple-100 to-indigo-100 text-purple-700 flex items-center justify-center font-bold text-sm shadow-sm"
                                     style="display: none;">
                            ...
                            <div class="flex items-start justify-between gap-3">
                                <div class="flex gap-3">
                                    ...
                                    <div class="relative flex-shrink-0">
                                        <img src="https://i.pravatar.cc/150?u={{ $expense->paidBy->email }}" 
