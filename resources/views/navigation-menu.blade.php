<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link href="{{ route('groups.index') }}" :active="request()->routeIs('groups.*')">Groups</x-responsive-nav-link>
            <x-responsive-nav-link href="{{ route('friends') }}" :active="request()->routeIs('friends')">Friends</x-responsive-nav-link>
            <x-responsive-nav-link href="{{ route('activity') }}" :active="request()->routeIs('activity')">Activity</x-responsive-nav-link>
            @if(auth()->user()->isAdmin())
