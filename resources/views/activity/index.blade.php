    ...
    <main class="flex-grow flex flex-col overflow-y-auto w-full max-w-full bg-white/65 backdrop-blur-sm">
        ...
        @if(session('success'))
            <div x-data="{ show: true }" x-show="show" x-init="setTimeout(() => show = false, 4000)" x-transition
                 class="m-6 mb-0 p-4 bg-green-100/80 border border-green-200 text-green-700 rounded-2xl text-sm font-semibold flex justify-between items-center transition duration-300">
                <span>{{ session('success') }}</span>
